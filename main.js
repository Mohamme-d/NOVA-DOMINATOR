...
let canalId = ["120363160031023229@newsletter", "120363301598733462@newsletter", "120363355261011910@newsletter", "120363297379773397@newsletter", "120363374372683775@newsletter"]
let canalNombre = ["NOVADOMINATORـWA 💫 💫", "SkyUltraPlus Host ☁️", "LoliBot ✨", "Test ✨", "Canal de memes/frases/videos 💓"]
...
let text = [`${lenguaje.Bio.text} ${Object.keys(global.db.data.users).length} ${lenguaje.Bio.text2} ${latensi.toFixed(4)} 🚀`, `${lenguaje.Bio.text3} ${uptime}\n\n${lenguaje.Bio.text4}`, `${lenguaje.Bio.text5}`, `👑 NOVADOMINATOR-Bot uso: ${conn.public ? 'Publico' : 'Privado'} | ${lenguaje.Bio.text6} ${uptime} | ${lenguaje.Bio.text7} ${Object.keys(global.db.data.users).length}`];
...
let updatee = execSync('git remote set-url origin https://github.com/elrebelde21/NOVADOMINATOR-Bot-MD.git && git pull')
